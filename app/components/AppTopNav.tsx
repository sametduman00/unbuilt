    ...
    <nav className="app-desktop-nav" style={{
      ...
      boxSizing: "border-box",
        ...
        <Link href="/?tab=stack" style={toolPill}
          ...
          onMouseLeave={e => { e.currentTarget.style.borderColor = "#e8e8e5"; e.currentTarget.style.boxShadow = "0 2px 12px rgba(0,0,0,0.06)"; }}
        >
          <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m12 2 8 4.5v11L12 22l-8-4.5v-11L12 2z"/><path d="m12 22v-6.5"/><path d="m20 7-8 4.5-8-4.5"/><path d="m20 17-8-4.5-8 4.5"/></svg>
          Get my Stack
        </Link>
        ...
        <Link href="/startup-ideas" style={toolPill}
          ...
          onMouseLeave={e => { e.currentTarget.style.borderColor = "#e8e8e5"; e.currentTarget.style.boxShadow = "0 2px 12px rgba(0,0,0,0.06)"; }}
        >
          <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M15 14c.2-1 .7-1.7 1.5-2.5 1-.9 1.5-2.2 1.5-3.5A6 6 0 0 0 6 8c0 1 .2 2.2 1.5 3.5.7.7 1.3 1.5 1.5 2.5"/><path d="M9 18h6"/><path d="M10 22h4"/></svg>
          Startup Ideas
        </Link>
        </div>
