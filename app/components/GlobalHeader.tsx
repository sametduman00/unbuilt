  ...
  return (
    <header style={{
      ...
      <div style={{ marginLeft: "auto", display: "flex", alignItems: "center", gap: 8, paddingRight: 20 }}>
        <Link href="/?tab=dig" style={{ textDecoration: "none", display: "flex", alignItems: "center", gap: 6, padding: "6px 14px", borderRadius: 8, background: "var(--clr-text)", color: "var(--clr-bg)", fontSize: "0.8rem", fontWeight: 700, letterSpacing: "-0.01em" }}>
