  ...
  return (
    <>
      <header className="app-mobile-header">
        ...
        <a href="/pricing" style={{ fontSize:12, fontWeight:600, color:"#7c6fff", textDecoration:"none", background:"rgba(124,111,255,0.08)", border:"0.5px solid rgba(124,111,255,0.25)", borderRadius:999, padding:"5px 12px" }}>Buy Credits</a>
      </header>
      <nav className="app-mobile-nav">
        ...
        <a href="/pricing"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="16"/><line x1="8" y1="12" x2="16" y2="12"/></svg><span>Credits</span></a>
      </nav>
    </>
  );
}
