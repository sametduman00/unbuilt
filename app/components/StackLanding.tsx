  ...
  return (
    <div ref={rootRef}>
      ...
      <div className="sl-section" style={{ textAlign: "center", paddingTop: "8rem" }}>
        ...
        <div data-a="scale" data-d="3" style={{ position: "relative", width: 340, height: 340, margin: "0 auto" }}>
          {/* Center */}
          ...
          {/* Orbiting tools — 4 rings with brand colors */}
          {[
            ...
            { name: "Firebase", bg: "#DD2C00", r: 95, dur: "11s", d: "1.57s" },
            ...
            { name: "Railway", bg: "#0B0D0E", r: 95, dur: "11s", d: "9.42s" },
            ...
            { name: "Lemon", bg: "#7047EB", r: 158, dur: "22s", d: "19.55s" },
          ].map((t, i) => (
            <div key={i} style={{ position: "absolute", top: "50%", left: "50%", width: 0, height: 0 }}>
              <div className="sl-orbit" style={{ "--r": `${t.r}px`, "--dur": t.dur, animationDelay: t.d } as React.CSSProperties}>
                <div style={{ padding: "3px 8px", borderRadius: 6, background: t.bg, display: "flex", alignItems: "center", justifyContent: "center", transform: "translate(-50%,-50%)", boxShadow: "0 2px 8px rgba(0,0,0,0.18)", whiteSpace: "nowrap" }}>
                  <span style={{ fontSize: 8, color: t.bg === "#00e9a3" ? "#111" : "#fff", fontWeight: 700, letterSpacing: "-0.02em" }}>{t.name}</span>
                </div>
              </div>
            </div>
          ))}
