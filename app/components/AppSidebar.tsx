  ...
  return (
    <aside style={{ width: 220, minWidth: 220, background: "var(--clr-surface)", borderRight: "1px solid var(--clr-border)", display: "flex", flexDirection: "column", position: "fixed", top: 0, bottom: 0, left: 0, zIndex: 50 }}>
      ...
      <div style={{ padding: "0 10px 4px" }}>
        ...
        <ToolItem tool="gap-analysis" label="Gap Analysis" dot="#7c6fff" badge={isSignedIn ? "1 credit" : undefined} locked={!isSignedIn} />
        <ToolItem tool="stack-advisor" label="Stack Advisor" dot="#38bdf8" badge={isSignedIn ? "1 credit" : undefined} locked={!isSignedIn} />
      </div>
