  ...
  return (
    <div>
      <section style={{ marginBottom: "2rem" }}>
        <h2 style={{ fontSize: 20, fontWeight: 600, color: "var(--clr-text)", marginBottom: "0.75rem" }}>Overview</h2>
        <p style={{ color: "var(--clr-text)", marginBottom: "1rem" }}>
      ...
      <section style={{ marginBottom: "2rem" }}>
        <h2 style={{ fontSize: 20, fontWeight: 600, color: "var(--clr-text)", marginBottom: "0.75rem" }}>Used Credits — No Refunds</h2>
        <p style={{ color: "var(--clr-text)", marginBottom: "1rem" }}>
      ...
      <section style={{ marginBottom: "2rem" }}>
        <h2 style={{ fontSize: 20, fontWeight: 600, color: "var(--clr-text)", marginBottom: "0.75rem" }}>Unused Credits — Full Refund Within 14 Days</h2>
        <p style={{ color: "var(--clr-text)", marginBottom: "1rem" }}>
      ...
      <section style={{ marginBottom: "2rem" }}>
        <h2 style={{ fontSize: 20, fontWeight: 600, color: "var(--clr-text)", marginBottom: "0.75rem" }}>Technical Failures</h2>
        <p style={{ color: "var(--clr-text)", marginBottom: "1rem" }}>
      ...
      <section>
        <h2 style={{ fontSize: 20, fontWeight: 600, color: "var(--clr-text)", marginBottom: "0.75rem" }}>Contact</h2>
        <p style={{ color: "var(--clr-text)" }}>Questions? Email support@unbuilt.me. We respond within 1 business day.</p>
      </section>
    </div>
  );
}
