...
export default function AITransparencyPage() {
  return (
    <>
      ...
      <S><H2>3. Limitations of AI</H2><P>You acknowledge that the system:</P><UL><LI>may produce incorrect, incomplete, or outdated results</LI><LI>does not have real-time knowledge or awareness</LI><LI>does not verify all external data sources</LI><LI>may reflect biases present in training data</LI></UL><P>AI outputs should not be treated as facts.</P></S>
