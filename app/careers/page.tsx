...
const values = [
  {
    ...
    desc: "We deploy daily. Perfect is the enemy of live. We'd rather get something in front of users tomorrow than polish it for a month.",
  },
  {
    icon: "🎯",
    title: "Obsess over founders",
    desc: "Every feature we build starts with a founder's frustration. We talk to users constantly and build what they actually need.",
  },
  {
    icon: "🔍",
    title: "Truth over comfort",
    desc: "We built Unbuilt because too many tools tell founders what they want to hear. We hold ourselves to the same standard internally.",
  },
  {
    icon: "🌍",
    title: "Async-first, globally distributed",
    desc: "We don't care where you are. We care what you build. Overlap with at least one team member is enough.",
  },
];
  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--clr-bg)", color: "var(--clr-text)" }}>
      ...
      <section style={{
        ...
        textAlign: "center",
        maxWidth: 760, margin: "0 auto", padding: "140px 2rem 80px",
      }}>
        <div style={{
        ...
        <h1 style={{
          ...
          lineHeight: 1.05, marginBottom: 24, color: "var(--clr-text)",
        }}>
          Help founders stop building<br />
          <span style={{ color: "var(--clr-accent)" }}>the wrong thing.</span>
        </h1>
        <p style={{
          fontSize: "1.125rem", color: "var(--clr-text-3)",
      ...
      {/* Values */}
      <section style={{
        maxWidth: 1100, margin: "0 auto", padding: "0 2rem 100px",
      }}>
        <h2 style={{
        ...
        <div style={{
          ...
          {values.map(v => (
            <div key={v.title} style={{
              ...
              <h3 style={{ fontSize: "1rem", fontWeight: 700, marginBottom: 8, color: "var(--clr-text)" }}>
                {v.title}
              </h3>
              <p style={{ fontSize: "0.875rem", color: "var(--clr-text-3)", lineHeight: 1.65 }}>
                {v.desc}
              </p>
            </div>
          ))}
      ...
      {/* Open Roles */}
      <section style={{
        maxWidth: 860, margin: "0 auto", padding: "0 2rem 120px",
      }}>
        <h2 style={{
          fontSize: "1.75rem", fontWeight: 700,
          ...
          {roles.map(role => (
            <div key={role.id} style={{
              ...
              <div style={{ flex: 1 }}>
                ...
                <h3 style={{ fontSize: "1.125rem", fontWeight: 700, marginBottom: 8, color: "var(--clr-text)" }}>
                  {role.title}
                </h3>
              ...
              <a
                href={`mailto:builder@unbuilt.me?subject=Application: ${encodeURIComponent(role.title)}&body=Hi Unbuilt team,%0D%0A%0D%0AI'd like to apply for the ${encodeURIComponent(role.title)} role.%0D%0A%0D%0A[Tell us about yourself and why you'd be a great fit]`}
                style={{
                  flexShrink: 0,
      ...
      <section style={{
        ...
        <p style={{
          color: "var(--clr-text-3)", maxWidth: 480, margin: "0 auto 32px",
          lineHeight: 1.65, fontSize: "0.9375rem",
        }}>
