...
// Verify Clerk webhook signature using Web Crypto (no external package needed)
async function verifyClerkSignature(req: NextRequest): Promise<{ valid: boolean; payload?: Record<string, unknown> }> {
  ...
  // Decode base64 secret (svix secrets start with "whsec_")
  ...
  // svix-signature may contain multiple sigs: "v1,xxx v1,yyy"
