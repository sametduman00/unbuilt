...
const TOOLS = [
  {
    ...
    label: "ALWAYS FREE",
    name: "Pulse",
    description: "Browse trending products Ã¢ÂÂ no credits needed, ever.",
    features: [
      "Product Hunt & App Store Ã¢ÂÂ daily",
      "AI breakdown: WHAT it does ÃÂ· DIFF ÃÂ· MISS",
    ...
    >
      ...
      <div style={{ textAlign: "center", marginBottom: 56 }}>
        ...
        <p style={{ fontSize: 16, color: "var(--clr-muted)", maxWidth: 520, margin: "0 auto" }}>
          Every account gets 2 free queries Ã¢ÂÂ 1 Gap Analysis + 1 Stack Advisor.
          Pulse is always free. When you need more, buy a credit pack.
        </p>
      </div>

      {/* Ã¢ÂÂÃ¢ÂÂ Why so expensive? honest box Ã¢ÂÂÃ¢ÂÂ */}
      <div
        style={{
      ...
      >
        <div style={{ flex: 1, minWidth: 220 }}>
          ...
          <p style={{ fontSize: 14, color: "var(--clr-muted)", lineHeight: 1.6, margin: 0 }}>
            We use <strong style={{ color: "var(--clr-text)" }}>Claude Opus 4.6 with Extended Thinking</strong> Ã¢ÂÂ Anthropic's most capable model with deep reasoning. Every query runs a full analysis, not a shortcut. The real cost to us is ~$0.45. You pay $0.40.
          </p>
        </div>
      ...
      {/* Ã¢ÂÂÃ¢ÂÂ Credit packs Ã¢ÂÂÃ¢ÂÂ */}
            ...
            >
              ...
              <div>
                ...
                <div style={{ fontSize: 13, color: "var(--clr-muted)", marginTop: 6 }}>
                  {pkg.credits} queries ÃÂ· {pkg.perQuery}/query
                </div>
              </div>
              <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: 8 }}>
                {[
                  ...
                  <li key={f} style={{ display: "flex", alignItems: "flex-start", gap: 8, fontSize: 13, color: "var(--clr-muted)" }}>
                    <span style={{ color: "var(--clr-accent)", fontWeight: 700, marginTop: 1 }}>Ã¢ÂÂ</span>
                    {f}
                  </li>
                ))}
              </ul>
      ...
      {/* Ã¢ÂÂÃ¢ÂÂ Tool cards Ã¢ÂÂÃ¢ÂÂ */}
      <h2 style={{ fontSize: 20, fontWeight: 700, color: "var(--clr-text)", marginBottom: 24, textAlign: "center" }}>
        What's included
      </h2>
              ...
              <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: 6 }}>
                {tool.features.map((f) => (
                  <li key={f} style={{ display: "flex", alignItems: "flex-start", gap: 8, fontSize: 12, color: "var(--clr-muted)" }}>
                    <span style={{ color: "var(--clr-accent)", fontWeight: 700, flexShrink: 0, marginTop: 1 }}>Ã¢ÂÂ</span>
                    {f}
                  </li>
                ))}
              </ul>
      ...
      {/* Ã¢ÂÂÃ¢ÂÂ Donate section Ã¢ÂÂÃ¢ÂÂ */}
      <div
        style={{
          textAlign: "center",
